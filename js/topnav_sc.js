...
//Contents for menu 1
var menu1=new Array()
menu1[0]='<a href="'+imgpref+'about/china/index.html" onclick="" onmouseover="mouseOverDD(this);globaloffdropdownH();" onmouseout="mouseOutDD(this);globaloffdropdownS();"><img src="'+imgpref+'img/shared/dropdown-china_sc-off.gif" border="0" alt=""></a>'
menu1[1]='<a href="'+imgpref+'about/business/index.html" onclick="" onmouseover="mouseOverDD(this);globaloffdropdownH();" onmouseout="mouseOutDD(this);globaloffdropdownS();"><img src="'+imgpref+'img/shared/dropdown-business_sc-off.gif" border="0" alt=""></a>'
menu1[2]='<a href="'+imgpref+'about/client/index.html" onclick="" onmouseover="mouseOverDD(this);globaloffdropdownH();" onmouseout="mouseOutDD(this);globaloffdropdownS();"><img src="'+imgpref+'img/shared/dropdown-client_sc-off.gif" border="0" alt=""></a>'
menu1[3]='<a href="'+imgpref+'about/company/index.html" onclick="" onmouseover="mouseOverDD(this);globaloffdropdownH();" onmouseout="mouseOutDD(this);globaloffdropdownS();"><img src="'+imgpref+'img/shared/dropdown-company_sc-off.gif" border="0" alt=""></a>'
menu1[4]='<a href="'+imgpref+'about/awards/index.html" onclick="" onmouseover="mouseOverDD(this);globaloffdropdownH();" onmouseout="mouseOutDD(this);globaloffdropdownS();"><img src="'+imgpref+'img/shared/dropdown-awards_sc-off.gif" border="0" alt=""></a>'
menu1[5]='<a href="'+imgpref+'about/global/index.html" onclick="" onmouseover="mouseOverDD(this);globaloffdropdownH();" onmouseout="mouseOutDD(this);globaloffdropdownS();"><img src="'+imgpref+'img/shared/dropdown-global_sc-off.gif" border="0" alt=""></a>'
menu1[6]='<a href="'+imgpref+'about/careers/index.html" onclick="" onmouseover="mouseOverDD(this);globaloffdropdownH();" onmouseout="mouseOutDD(this);globaloffdropdownS();"><img src="'+imgpref+'img/shared/dropdown-career_sc-off.gif" border="0" alt=""></a>'
...
//Contents for menu 3
var menu3=new Array()
menu3[0]='<a href="'+imgpref+'press/index.html" onclick="" onmouseover="mouseOverDD(this);globaloffdropdownH();" onmouseout="mouseOutDD(this);globaloffdropdownS();"><img src="'+imgpref+'img/shared/dropdown-press_sc-off.gif" border="0" alt=""></a>'
menu3[1]='<a href="'+imgpref+'press/others/index.html" onclick="" onmouseover="mouseOverDD(this);globaloffdropdownH();" onmouseout="mouseOutDD(this);globaloffdropdownS();"><img src="'+imgpref+'img/shared/dropdown-othernews_sc-off.gif" border="0" alt=""></a>'
